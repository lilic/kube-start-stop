...
import (
	...
	scheme "github.com/lilic/kube-start-stop/pkg/client/clientset/versioned/scheme"
...
func (c *schedules) UpdateStatus(schedule *v1alpha1.Schedule) (result *v1alpha1.Schedule, err error) {
	result = &v1alpha1.Schedule{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("schedules").
