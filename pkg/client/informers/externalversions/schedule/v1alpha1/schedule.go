...
import (
	...
	schedule_v1alpha1 "github.com/lilic/kube-start-stop/pkg/apis/schedule/v1alpha1"
	versioned "github.com/lilic/kube-start-stop/pkg/client/clientset/versioned"
	internalinterfaces "github.com/lilic/kube-start-stop/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/lilic/kube-start-stop/pkg/client/listers/schedule/v1alpha1"
...
func (f *scheduleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&schedule_v1alpha1.Schedule{}, f.defaultInformer)
}
